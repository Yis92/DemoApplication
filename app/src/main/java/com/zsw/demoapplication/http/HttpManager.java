...
public class HttpManager {
    ...
    private void _getAsyn(String url, final ResultCallback callback) {
        final Request request = new Request.Builder()
                .header("User-Agent", "ZHIXIAO_A")//自定义User-Agent信息
                .url(url)
                .build();
    ...
    private void _postAsyn(String url, final ResultCallback callback, Map<String, String> params) {
        ...
        sb.append(":\n");
        sb.append("====================Success Response Start====================\n");
        sb.append("requestBody:");
        sb.append(new Gson().toJson(params) + "\n");
    ...
    public static void postAsyn(String url, final ResultCallback callback, File file, String s, Map<String, String> paramMap, Param... params) {
        ...
        mOkHttpClient.newCall(request).enqueue(new Callback() {
            ...
            public void onResponse(final Response response) {
                try {
                    ...
                    //打印返回的参数
                    StringBuilder sb = new StringBuilder();
                    sb.append("type:" + request.method() + "\n");
                    sb.append("url:" + request.urlString() + "\n");
                    sb.append("responseBody:" + string + "\n");
                    sb.append("====================Success Response End====================");
    ...
    private Request buildPostRequest(String url, Param[] params) {
        ...
        RequestBody requestBody = builder.build();
        return new Request.Builder()
                .header("User-Agent","ZHIXIAO_A")//自定义User_Agent信息
                .url(url)
                .post(requestBody)
                .build();
    }
